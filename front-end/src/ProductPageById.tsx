...
import styles from './Pages/Website/products/productPage.module.css'
...
interface Product{
  ...
  const showImages =Array.isArray(singleProduct?.image) ?singleProduct.image
  .filter((img): img is string => typeof img === 'string') // Ensure all images are strings
...
localStorage.setItem('cart', JSON.stringify(cart));
  ...
  return (
    ...
    {singleProduct ? (
      <div  className={`${styles.container} d-flex flex-wrap  align-items-center justify-content-between  row-gap-3 h-fit-content py-3`} >
