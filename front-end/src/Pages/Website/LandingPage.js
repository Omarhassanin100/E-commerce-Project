      ...
      <Carousel.Item interval={1000}  className={styles.contentParent}>
        <div className={`d-flex felx-row justify-content-around align-items-center h-100 ${styles.contentParent}`} style={{backgroundColor:"linen"}}>
          ...
          <div className='text-center'>
            ...
            <Link className={`${styles.carouselButto} mx-3 my-3 py-3 px-3 fw-bold text-light`} style={{backgroundColor:"indianred"}}>
              SHOP NOW
            </Link>
            </div>
          </div>
      ...
      <Carousel.Item interval={1000} className={styles.contentParent}>
        <div className={`d-flex felx-row justify-content-around align-items-center h-100 ${styles.contentParent}`} style={{backgroundColor:"#d5bbec"}}>
          ...
          <div className='text-center'>
            ...
            <div className='mx-3 my-3 py-3 px-3'>
            <Link className={`${styles.carouselButto} mx-3 my-3 py-3 px-3 fw-bold text-light`} style={{backgroundColor:"rgb(145 93 142)"}}>
              SHOP NOW
            </Link>
            </div>
          </div>
      ...
      <Carousel.Item interval={1000} className={styles.contentParent}>
        <div className={`d-flex felx-row justify-content-around align-items-center h-100 ${styles.contentParent}`} style={{backgroundColor:"linen"}}>
          ...
          <div className='text-center'>
            ...
            <div className='mx-3 my-3 py-3 px-3'>
            <Link className={`${styles.carouselButto} mx-3 my-3 py-3 px-3 fw-bold text-light`} style={{backgroundColor:"#ec1f27"}}>
            SHOP NOW
            </Link>
            </div>
          </div>
      ...
      <Carousel.Item interval={1000} className={styles.contentParent}>
        <div className={`d-flex felx-row justify-content-around align-items-center h-100 ${styles.contentParent}`} style={{backgroundColor:"linen"}}>
          ...
          <div className='text-center'>
            ...
            <div className='mx-3 my-3 py-3 px-3'>
            <Link className=' mx-3 my-3 py-3 px-3 fw-bold text-light'style={{textDecoration:"none",borderRadius:"0.375rem",backgroundColor:"#ad295b"}}>
            SHOP NOW
            </Link>
          </div>
          </div>
